...
<h1 align="center"> 
    Typemaster pre-launch landing page <br> 
    <hr>
    <img alt="Typemaster pre-launch landing page" title="" src="./readme/typemaster.png"/>
</h1>

<h4 align="center"> 
	🚧 Typemaster pre-launch landing page ✔️ Concluído 🚀 🚧
</h4>
...
✔️ Typemaster pre-launch landing page - É uma página de destino de pré-lançamento do Typemaster.

✔️ Este projeto é um desafio do site Frontend Mentor onde pude me aprofundar sobre media queries, CSS Grid e organização do layout, tive um pouco de dificuldade no responsivo, mas consegui um bom resultado de acordo com uma das funcionalidades pedida no projeto de adaptar a qualquer tipo de tela.
...
<p align="center">
  <img alt="Typemaster pre-launch landing page" title="#Typemasterprelaunchlandingpage" src="./readme/mobile1.png">
